...
void protobuf_AddDesc_msg_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\tmsg.proto\022\010protobuf\"\036\n\003Msg\022\n\n\002id\030\001 \002(\005"
    "\022\013\n\003str\030\002 \002(\t", 53);
...
Msg::Msg()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:protobuf.Msg)
}
...
Msg::Msg(const Msg& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:protobuf.Msg)
}
...
Msg::~Msg() {
  // @@protoc_insertion_point(destructor:protobuf.Msg)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:protobuf.Msg)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:protobuf.Msg)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:protobuf.Msg)
  return false;
#undef DO_
}
...
void Msg::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:protobuf.Msg)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:protobuf.Msg)
}

::google::protobuf::uint8* Msg::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:protobuf.Msg)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.Msg)
  return target;
}
